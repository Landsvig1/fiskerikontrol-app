          ...
          <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-6 py-4 bg-white border-b border-slate-200 z-25 shadow-xs">
            ...
            <nav className="flex gap-1 bg-slate-100 p-1 rounded-xl border border-slate-200 flex-wrap">
              <button
                ...
                className="px-3.5 py-1.5 rounded-lg text-xs font-medium text-slate-600 hover:text-slate-900 hover:bg-white/60 transition-all duration-200 cursor-pointer"
              >
                {"← Upload & Korpus"}
              </button>
              <button
                type="button"
                className="px-3.5 py-1.5 rounded-lg text-xs font-semibold bg-white text-slate-900 shadow-xs border border-slate-200/80 transition-all duration-200 cursor-pointer"
              >
          ...
          <main className="flex-1 flex overflow-hidden">
            <ErrorBoundary t={t}>
              <MatrixExplorer
                ...
                onSelectNode={(nodeId) => setUrlState({ matrixNode: nodeId })}
                onSelectYear={(year) => setUrlState({ matrixYear: year })}
              />
            </ErrorBoundary>
          </main>
        </div>
